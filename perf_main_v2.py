...
def load_params(argv):
    ...
    def usage():
        ...
        print msg
    try:
        opts, args = getopt.getopt(argv,"m:p:x:f:h:c:t:o:a:r:",["ms-file=","pan-file=","xml-file=","filter=","histogram-match=","cutoff-freq=","ps-method=","out-file=","multi-thread","run-times="])
    ...
    for i in range(run_times):
        ...
        if (ps_method == 'fft' and is_multi_thread):
            ...
            if hist_m:            
                ...
                th12.join(); th15.start()
                # Run Part 6 - Creating Pan-Sharpenned Image
                th13.join(); th16.start()
                th14.join(); th17.start()
                th15.join(); th18.start()
                # Run Part7 - I-FFT of PS Image
                th16.join(); th19.start()
                th17.join(); th20.start()
                th18.join(); th21.start()
